...
//import UIKit
//
//class AddIncomeViewController: UIViewController, UIPickerViewDelegate {
//    
...
//        handler?(IncomeItem(link: nil, deadline: nil, made: nil, paid: nil, name: nameTextField.text ?? "", price: nil, numberOfSigns: nil, customer: customerTextField.text))
